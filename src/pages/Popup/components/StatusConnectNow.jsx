...
const StatusConnectNow = ({ fill, connectNow, scopeBuilderLink }) => {
  return (
    <div
      className={`bg-gradient-blue flex-1 rounded-[10px] flex items-center justify-center`}
    >
      {scopeBuilderLink ? (
        ...
        <div>
          ...
          <div className="w-fit mx-auto">
            <button
              ...
              className={`
                       text-[#1890FF] bg-white font-medium uppercase   text-[16px] py-[16px] px-[32px] rounded-[4px] `}
            >
              Connect Now
            </button>
          </div>
...
export default StatusConnectNow;
